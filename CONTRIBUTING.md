Contributing to Nasda Cash
============================

The Nasda Cash project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/nasdacash-project/nasdacash/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Nasda Cash project, and is not to be
confused with overall Nasda_Cash Network Protocol consensus changes.

Whether a pull request is merged into Nasda Cash rests with the project merge
...
Patches that change Nasda_Cash consensus rules are considerably more involved than
...
Where a patchset proposes to change the Nasda_Cash consensus, it must have been
...
The project leader is the release manager for each Nasda Cash release.

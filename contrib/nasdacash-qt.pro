...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/nasdacash-cli.cpp \
           src/nasdacash-tx.cpp \
           src/nasdacash.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/nasdacash.qrc src/qt/nasdacash_locale.qrc

TRANSLATIONS += src/qt/locale/nasdacash_bg.ts \
                src/qt/locale/nasdacash_de.ts \
                src/qt/locale/nasdacash_en.ts \
                src/qt/locale/nasdacash_es.ts \
                src/qt/locale/nasdacash_fi.ts \
                src/qt/locale/nasdacash_fr.ts \
                src/qt/locale/nasdacash_it.ts \
                src/qt/locale/nasdacash_ja.ts \
                src/qt/locale/nasdacash_pl.ts \
                src/qt/locale/nasdacash_pt.ts \
                src/qt/locale/nasdacash_ru.ts \
                src/qt/locale/nasdacash_sk.ts \
                src/qt/locale/nasdacash_sv.ts \
                src/qt/locale/nasdacash_vi.ts \
                src/qt/locale/nasdacash_zh_CN.ts \
                src/qt/locale/nasdacash_zh_TW.ts

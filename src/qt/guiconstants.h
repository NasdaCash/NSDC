...
/* NasdaCash GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Nasda_Cash"
#define QAPP_ORG_DOMAIN "nasdacash.org"
#define QAPP_APP_NAME_DEFAULT "Nasda_Cash-Qt"
#define QAPP_APP_NAME_TESTNET "Nasda_Cash-Qt-testnet"

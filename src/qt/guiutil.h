...
/** Utility functions used by the Nasda_Cash Qt UI.
 */
namespace GUIUtil
{
...
// Render Nasda_Cash addresses in monospace font
...
// Parse "nasdacash:" URI into recipient object, return true on successful parsing

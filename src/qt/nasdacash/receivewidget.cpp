...
#include "qt/nasdacash/forms/ui_receivewidget.h"
...
#include "qt/nasdacash/addressholder.h"
...
ReceiveWidget::ReceiveWidget(Nasda_CashGUI* parent) :
    PWidget(parent),

...
#include "qt/nasdacash/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(Nasda_CashGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &Nasda_CashGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);

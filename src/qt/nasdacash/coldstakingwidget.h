...
#include "qt/nasdacash/furabstractlistitemdelegate.h"
#include "qt/nasdacash/txviewholder.h"
#include "qt/nasdacash/tooltipmenu.h"
#include "qt/nasdacash/sendmultirow.h"
#include "qt/nasdacash/coldstakingmodel.h"
#include "qt/nasdacash/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(Nasda_CashGUI* parent);
    ~ColdStakingWidget();

...
#include "qt/nasdacash/forms/ui_addresseswidget.h"
#include "qt/nasdacash/addresslabelrow.h"
#include "qt/nasdacash/addnewaddressdialog.h"
#include "qt/nasdacash/tooltipmenu.h"
...
AddressesWidget::AddressesWidget(Nasda_CashGUI* parent) :
    PWidget(parent),
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        CTxDestination nasdacashAdd = DecodeDestination(address.toUtf8().constData(), isStakingAddress);
        ...
        if (walletModel->updateAddressBookLabels(nasdacashAdd, label.toUtf8().constData(),

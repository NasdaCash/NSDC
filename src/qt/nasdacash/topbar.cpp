...
#include "qt/nasdacash/topbar.h"
#include "qt/nasdacash/forms/ui_topbar.h"
#include "qt/nasdacash/lockunlock.h"
#include "qt/nasdacash/qtutils.h"
#include "qt/nasdacash/receivedialog.h"
#include "qt/nasdacash/loadingdialog.h"
...
TopBar::TopBar(Nasda_CashGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopNsdc}, "amount-small-topbar");
    setCssProperty({ui->labelAmountNsdc}, "amount-topbar");
    setCssProperty({ui->labelPendingNsdc, ui->labelImmatureNsdc}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("Nasda_Cash")
    updateDisplayUnit();
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // NSDC Total
    QString totalNsdc = GUIUtil::formatBalance(balance, nDisplayUnit);

    // NSDC
    // Top
    ui->labelAmountTopNsdc->setText(totalNsdc);
    // Expanded
    ui->labelAmountNsdc->setText(totalNsdc);
    ui->labelPendingNsdc->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureNsdc->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}

...
#include "qt/nasdacash/settings/settingsnetworkwidget.h"
#include "qt/nasdacash/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/nasdacash/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(Nasda_CashGUI* _window, QWidget *parent) :

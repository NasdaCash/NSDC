...
#include "qt/nasdacash/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/nasdacash/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(Nasda_CashGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Nasda Cash RPC console.") + "<br>" +

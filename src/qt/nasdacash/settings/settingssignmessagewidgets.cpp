...
#include "qt/nasdacash/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(Nasda_CashGUI* _window, QWidget *parent) :

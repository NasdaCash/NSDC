...
#include "qt/nasdacash/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(Nasda_CashGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &Nasda_CashGUI::openFAQ);

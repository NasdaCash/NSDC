...
#include "qt/nasdacash/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(Nasda_CashGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("Nasda_Cash_tx_csv_export(*.csv)") : tr("Nasda_Cash_addresses_csv_export(*.csv)"),
                                        nullptr);

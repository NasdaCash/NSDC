...
#include "qt/nasdacash/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/nasdacash/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(Nasda_CashGUI* _window, QWidget *parent) :

...
#include "qt/nasdacash/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/nasdacash/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(Nasda_CashGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to Nasda_CashGUI::handleRestart()

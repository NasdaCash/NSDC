...
#include "qt/nasdacash/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/nasdacash/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(Nasda_CashGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableNSDC,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableNSDC,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableNSDC,
    ...
    connect(ui->pushButton_UnspendableNSDC, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableNSDC);});
    ...
    if (parent)
        connect(parent, &Nasda_CashGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}

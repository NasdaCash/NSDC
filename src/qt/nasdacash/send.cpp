...
#include "qt/nasdacash/forms/ui_send.h"
#include "qt/nasdacash/addnewcontactdialog.h"
#include "qt/nasdacash/qtutils.h"
#include "qt/nasdacash/sendchangeaddressdialog.h"
#include "qt/nasdacash/optionbutton.h"
#include "qt/nasdacash/sendconfirmdialog.h"
#include "qt/nasdacash/myaddressrow.h"
#include "qt/nasdacash/guitransactionsutils.h"
...
SendWidget::SendWidget(Nasda_CashGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    ...
    btnContacts(new QPushButton())
{
    ...
    setCssProperty(coinIcon, "coin-icon-nsdc");
...
void SendWidget::onContactMultiClicked()
{
    if (focusedEntry) {
        ...
        CTxDestination nasdacashAdd = DecodeDestination(address.toStdString());
        if (walletModel->isMine(nasdacashAdd)) {
        ...
        if (dialog->res) {
            ...
            if (walletModel->updateAddressBookLabels(nasdacashAdd, dialog->getLabel().toStdString(),
                    AddressBook::AddressBookPurpose::SEND)) {

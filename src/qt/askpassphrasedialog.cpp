...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            Nasda_CashGUI* window = static_cast<Nasda_CashGUI*>(parentWidget());
...
{
    Nasda_CashGUI* gui = static_cast<Nasda_CashGUI*>(parentWidget());
...
{
    hide();
    static_cast<Nasda_CashGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Nasda_Cash will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your NSDCs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +

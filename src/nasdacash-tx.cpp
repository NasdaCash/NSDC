...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Nasda Cash nasdacash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nasdacash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nasdacash transaction") + "\n" +
                               "  nasdacash-tx [options] -create [commands]   " + _("Create hex-encoded nasdacash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nasdacash transaction

...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop Nasda_Cash server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Nasda_Cash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Nasda_Cash features */
        {"nasdacash", "listmasternodes", &listmasternodes, true },
        {"nasdacash", "getmasternodecount", &getmasternodecount, true },
        {"nasdacash", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"nasdacash", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"nasdacash", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"nasdacash", "masternodecurrent", &masternodecurrent, true },
        {"nasdacash", "startmasternode", &startmasternode, true },
        {"nasdacash", "createmasternodekey", &createmasternodekey, true },
        {"nasdacash", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"nasdacash", "listmasternodeconf", &listmasternodeconf, true },
        {"nasdacash", "getmasternodestatus", &getmasternodestatus, true },
        {"nasdacash", "getmasternodewinners", &getmasternodewinners, true },
        {"nasdacash", "getmasternodescores", &getmasternodescores, true },
        {"nasdacash", "preparebudget", &preparebudget, true },
        {"nasdacash", "submitbudget", &submitbudget, true },
        {"nasdacash", "mnbudgetvote", &mnbudgetvote, true },
        {"nasdacash", "getbudgetvotes", &getbudgetvotes, true },
        {"nasdacash", "getnextsuperblock", &getnextsuperblock, true },
        {"nasdacash", "getbudgetprojection", &getbudgetprojection, true },
        {"nasdacash", "getbudgetinfo", &getbudgetinfo, true },
        {"nasdacash", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"nasdacash", "mnfinalbudget", &mnfinalbudget, true },
        {"nasdacash", "checkbudgets", &checkbudgets, true },
        {"nasdacash", "mnsync", &mnsync, true },
        {"nasdacash", "spork", &spork, true },
...
{
    return "> nasdacash-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:15017/\n";
}
